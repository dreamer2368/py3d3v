...
class TestPICBaseExamples(unittest.TestCase):
    ...
    def test_static_E_SHM(self):
        ...
        # init half step back
        Ezp = interp_particles(2, Ez, pic.zp, dz, pic.yp, dy, pic.xp, dx)
        Eyp = interp_particles(2, Ey, pic.zp, dz, pic.yp, dy, pic.xp, dx)
        Exp = interp_particles(2, Ex, pic.zp, dz, pic.yp, dy, pic.xp, dx)
