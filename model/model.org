...
particles cell or one of its 26 neighboors. For each particle short
...
The lines define cells and the points of the computational mesh
are the gray dots.}
...
convolution theorem to efficiently calculate
