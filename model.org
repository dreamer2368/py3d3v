...
computational mesh. Each particle belongs to one and only one cell in
this coarse mesh. For each particle short range interactions are then
calculated bettween other particles sharing its cell and those in
neighbooring cells.
